        ...
        <form class="col-12 col-m-8" action="index.php" method="get">
            <div class="flex align-center">
                <div class="col-8 row">
                    ...
                    <label class="col-3" for="partialDsc">Descripción</label>
                    <input class="col-9" type="text" name="partialDsc" id="partialDsc" value="{{partialDsc}}" />
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Estado</th>
                <th><a href="index.php?page=Roles_Role&mode=INS">Nuevo</a></th>
            </tr>
        </thead>
        <tbody>
            {{foreach roles}}
            <tr>
                <td>{{rolescod}}</td>
                <td>{{rolesdsc}}</td>
                <td class="center">{{rolesStatusDsc}}</td>
                <td class="center">
